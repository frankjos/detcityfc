...
class Fishpig_Wordpress_PostController extends Fishpig_Wordpress_Controller_Abstract
{
	...
	{
		if ($response = $this->getRequest()->getParam('c')) {
			Mage::getSingleton('core/session')->addSuccess($this->__("Thank you for your comment. It may take a short while before it is approved by a moderator."));
		}
