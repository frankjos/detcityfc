jQuery(document).ready(function(){
			...
			jQuery('.atp-radio-img-img').click(function(){
				jQuery(this).parent().parent().find('.atp-radio-img-img').removeClass('atp-radio-img-selected');
				jQuery(this).addClass('atp-radio-img-selected');
			});
			jQuery('.atp-radio-img-label').hide();
			jQuery('.atp-radio-img-img').show();
			...
			jQuery('#atpform').submit(function(){
				...
				} else if(querystring_page == 'victoria') {
					var data = {
						type: 'victoria_options',
						action: 'atp_ajax_post_action',
						data: serializedReturn
					};
				}
